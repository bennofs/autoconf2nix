...
#define br_prepend_prefix BR_NAMESPACE(br_prepend_prefix)
    ...
    #define BR_LOCATE_CHAR( x ) br_locate(const_cast< void * >(static_cast< void const * >( x ) ) )
    #define BR_LOCATE_PREFIX_CHAR( x ) br_locate_prefix(const_cast< void * >(static_cast< void const * >( x ) ) )
    #define BR_PREPEND_PREFIX_CHAR( x ) br_prepend_prefix(const_cast< void * >(static_cast< void const * >( x ) ) )

	#define SELFPATH	(br_thread_local_store (BR_LOCATE_CHAR("")))
	#define PREFIX		(br_thread_local_store (BR_LOCATE_PREFIX_CHAR ((void *) "")))
	#define PREFIXDIR	(br_thread_local_store (BR_LOCATE_PREFIX_CHAR ((void *) "")))
	#define BINDIR		(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/bin")))
	#define SBINDIR		(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/sbin")))
	#define DATADIR		(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/share")))
	#define LIBDIR		(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/lib")))
	#define LIBEXECDIR	(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/libexec")))
	#define ETCDIR		(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/etc")))
	#define SYSCONFDIR	(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/etc")))
	#define CONFDIR		(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/etc")))
	#define LOCALEDIR	(br_thread_local_store (BR_PREPEND_PREFIX_CHAR ((void *) "", "/share/locale")))
#endif /* BR_NO_MACROS */
